<template>
  <div class="relative z-10">
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto mt-6">
      <div class="flex min-h-full items justify-center p-4 items-center pt-2">
        <div
          ...
          <div class="bg-white px-4 pt-5 pb-4 p-6">
            <div class="flex items-center">
              <div class="mt-3 text-left">
                <h3 class="text-2xl font-medium leading-6 text-gray-900">Обрезать изображение</h3>
                <div class="flex flex-wrap my-4">
                  ...
                  <div class="mb-3 w-full">
                    <input
                      ...
                      class="form-control block w-full text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-400 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                      type="file"
                    />
                  </div>
                </div>
                ...
                <div class="pt-3 flex flex-row-reverse px-4">
                  <button
                    v-if="uploadedImage"
                    @click="crop"
